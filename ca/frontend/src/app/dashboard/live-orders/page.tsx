...
export default function LiveOrdersPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FAF8F5] text-[#3A2A2B] font-sans flex flex-col overflow-hidden h-screen">
      ...
      {/* MONITOR HEADER */}
      <header className="bg-[#F3EDE2] border-b border-[#E5DAC6] px-6 py-4 flex items-center justify-between shrink-0">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <h1 className="font-serif text-lg tracking-wide text-[#2C1A1B] font-bold">Atelier Live Order Board</h1>
          </div>
        </div>
